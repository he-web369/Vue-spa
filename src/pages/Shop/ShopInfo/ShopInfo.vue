  ...
  <div class="shop-info">
    <div class="shop-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div :class="supportClasses[support.type]" class="activity-item" v-for="(support,index) in info.supports" :key='index'>
        ...
        <div class="pic-wrapper" ref="picList">
          <ul class="pic-list" ref="picUl">
            <li class="pic-item" v-for="(pic,index) in info.pics" :key='index'>
              <img :src="pic" alt="实景" width="120" height="90">
            </li>
          </ul>
        </div>
      </section>
...
export default {
  ...
  methods: {
    _initScroll(){
        new BSroll('.shop-info')
        const ul =this.$refs.picUl
        const count=this.info.pics.length
        ul.style.width=(count*126-6)+'px'
        this.scroll=new BSroll(this.$refs.picList,{
          scrollX:true
        })
    }
  },
